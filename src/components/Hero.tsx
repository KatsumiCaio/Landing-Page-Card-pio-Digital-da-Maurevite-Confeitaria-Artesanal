...
import { MessageCircle, Sparkles, ArrowRight, ShieldCheck, Heart, MapPin } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            {/* Subtle Brand Pill */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-zinc-300/80 bg-white/80 backdrop-blur-xs text-xs font-medium text-zinc-700 shadow-2xs">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3.5 pt-3">
              <a
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-7 py-3.5 rounded-full bg-[#1E2024] hover:bg-zinc-800 text-white text-sm font-medium tracking-wide transition-all shadow-sm hover:shadow-md active:scale-[0.99]"
              >
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              {/* Outer Elegant Frame */}
              <div className="relative rounded-2xl overflow-hidden border border-zinc-200/80 bg-white p-2.5 shadow-sm">
                ...
                <div className="absolute -top-4 -right-3 bg-white/95 backdrop-blur-sm border border-zinc-200/90 rounded-full p-2.5 shadow-md flex items-center gap-2">
              ...
              <div className="hidden sm:flex items-center gap-3 absolute -bottom-5 -left-4 bg-[#FAFAF8] border border-zinc-300/80 rounded-xl px-4 py-2.5 shadow-sm">
